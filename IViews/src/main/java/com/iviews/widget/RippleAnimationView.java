...
public class RippleAnimationView extends android.view.View {
    ...
    public static RippleAnimationView create(android.view.View onClickView) {
    ...
    private static float getAbsoluteX(android.view.View view) {
        ...
        if (parent != null && parent instanceof android.view.View) {
            x += getAbsoluteX((android.view.View) parent);
        }
        return x;
    }
    ...
    private static float getAbsoluteY(android.view.View view) {
        ...
        ViewParent parent = view.getParent();
        if (parent != null && parent instanceof android.view.View) {
            y += getAbsoluteY((android.view.View) parent);
        }
        return y;
    }
