...
public class MultHorizontalScaleScrollView extends BaseScaleScrollView {
    ...
    public void setIsInteger(boolean isIntegarl){
...
//        });
        ...
        //指针向下的
        LinearLayout.LayoutParams lpPointer = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);
