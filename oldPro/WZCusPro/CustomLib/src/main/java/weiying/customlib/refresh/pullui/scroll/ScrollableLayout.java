package weiying.customlib.refresh.pullui.scroll;
...
public class ScrollableLayout extends LinearLayout {
    ...
    public interface OnScrollListener {
        ...
        void onScrollStop(int currentY, int maxY);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if (onScrollListener != null && !stopMove) {
                    onScrollListener.onScrollStop(mCurY, maxY);
                }
...
//            return true;
//        }
        if (mCurY == minY && mHelper.isTop() && mIsHorizontalScrolling) {
            return true;
        }
        return false;
    }

    public void setStopMove(boolean isMove) {
        this.stopMove = isMove;
    }
}
