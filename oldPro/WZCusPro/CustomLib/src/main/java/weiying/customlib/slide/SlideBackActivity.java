package weiying.customlib.slide;
...
import weiying.customlib.BuildConfig;
...
public abstract class SlideBackActivity extends ActivityInterfaceImpl implements SlideFrameLayout.SlidingListener {
    ...
    public void setContentView(View view) {
        ...
        // 初始化
        mSlideFrameLayout.setShadowResource(R.drawable.base_sliding_back_shadow);
    ...
    public void setEdgeSize(int offset) {
        if (mSlideFrameLayout != null) {
            mSlideFrameLayout.setEdgeSize(offset);
        }
    }
