...
/**
 * @author fz
 * @version 创建时间：2016-12-27 上午11:40:49
 * 
 *          ElasticScrollView 弹性的ScrollView  
 */
public class ElasticScrollView extends ScrollView {

	public static final String TAG = "ElasticScrollView";

	private ElasticScrollListener scrollListener;
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_UP:
			...
			// anim.setInterpolator(new CycleInterpolator());
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		if(scrollListener !=null){
			scrollListener.onScrollChanged(ElasticScrollView.this, l, t, oldl, oldt);
		}
	}
	
	public void addOnScrollChangelListener(ElasticScrollListener listener){
