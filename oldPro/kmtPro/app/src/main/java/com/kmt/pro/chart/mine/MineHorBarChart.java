...
import com.kmt.pro.chart.render.MineHorizontalBarChartRenderer;
import com.kmt.pro.chart.render.MineXAxisRender;
import com.kmt.pro.chart.render.MineYAxisRendererHorizontalBarChart;

/**
 * Create by JFZ
 * date: 2020-05-21 11:06
 **/
public class MineHorBarChart extends HorizontalBarChart {

    public MineHorBarChart(Context context) {
        super(context);
    }

    public MineHorBarChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MineHorBarChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new MineHorizontalBarChartRenderer(this, mAnimator, mViewPortHandler);
        setHighlighter(new HorizontalBarHighlighter(this));

        mAxisRendererLeft = new MineYAxisRendererHorizontalBarChart(mViewPortHandler, mAxisLeft, mLeftAxisTransformer);
        mAxisRendererRight = new MineYAxisRendererHorizontalBarChart(mViewPortHandler, mAxisRight, mRightAxisTransformer);
        mXAxisRenderer = new MineXAxisRender(mViewPortHandler, mXAxis, mLeftAxisTransformer, this);
    }
...
//                Math.max(minOffset, offsetBottom));
        mViewPortHandler.restrainViewPort(0,0,0,0);
