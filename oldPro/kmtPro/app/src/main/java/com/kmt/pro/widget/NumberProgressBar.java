...
public class NumberProgressBar extends View {
    ...
    private final int default_text_color = Color.rgb(255, 130, 0);
    private final int default_reached_color = Color.rgb(255, 130, 0);
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_progress_text_offset = dp2px(6.0f);
