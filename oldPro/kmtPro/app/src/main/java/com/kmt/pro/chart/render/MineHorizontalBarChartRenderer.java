 ...
 */
public class MineHorizontalBarChartRenderer extends BarChartRenderer {

    public MineHorizontalBarChartRenderer(BarDataProvider chart, ChartAnimator animator,
