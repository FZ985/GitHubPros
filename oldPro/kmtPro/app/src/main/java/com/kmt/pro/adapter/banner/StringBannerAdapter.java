 ...
 * 自定义布局，图片
 */
public class StringBannerAdapter extends BannerAdapter<String, HomeBannerImageHolder> {

    public StringBannerAdapter(List<String> mDatas) {
    ...
    @Override
    public void onBindView(HomeBannerImageHolder holder, String data, int position, int size) {
        Glide.with(holder.imageView.getContext())
                .load(KConstant.img_url + data)
