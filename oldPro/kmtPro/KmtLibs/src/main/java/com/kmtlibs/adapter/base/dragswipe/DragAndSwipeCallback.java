package com.kmtlibs.adapter.base.dragswipe;
...
public class DragAndSwipeCallback extends ItemTouchHelper.Callback {
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        if (mDraggableModule != null) {
            mDraggableModule.onChildDraw(c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive);
        }
    }
    ...
    public long getAnimationDuration(@NonNull RecyclerView recyclerView, int animationType, float animateDx, float animateDy) {
        ...
        if (mDraggableModule != null) {
            return mDraggableModule.getAnimationDuration(recyclerView, animationType, animateDx, animateDy, duration);
        }
        return duration;
    }
