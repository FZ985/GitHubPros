...
import com.kmtlibs.banner.config.BannerConfig;
import com.kmtlibs.banner.config.IndicatorConfig;
import com.kmtlibs.banner.indicator.Indicator;
import com.kmtlibs.banner.listener.OnBannerListener;
import com.kmtlibs.banner.listener.OnPageChangeListener;
import com.kmtlibs.banner.transformer.MZScaleInTransformer;
import com.kmtlibs.banner.transformer.ScaleInTransformer;
import com.kmtlibs.banner.util.BannerLifecycleObserver;
import com.kmtlibs.banner.util.BannerLifecycleObserverAdapter;
import com.kmtlibs.banner.util.BannerUtils;
import com.kmtlibs.banner.util.LogUtils;
import com.kmtlibs.banner.util.ScrollSpeedManger;
...
public class Banner<T, BA extends BannerAdapter> extends FrameLayout implements BannerLifecycleObserver {
    ...
    public BA getAdapter() {
        if (mAdapter == null) {
            LogUtils.e("你还没有调用 setAdapter() 方法");
        }
        return mAdapter;
    }
    ...
    public Indicator getIndicator() {
        if (mIndicator == null) {
            LogUtils.e("请先调用setIndicator()方法来设置指示器");
        }
        return mIndicator;
    }
