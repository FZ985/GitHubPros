...
import com.kmtlibs.app.HomeKeyWatcher;
import com.kmtlibs.app.handler.HandlerHelperAdapter;
import com.kmtlibs.app.receive.IBroadcastRecvHandler;
import com.kmtlibs.app.receive.RecvCallBack;
...
//        mHomeKeyWatcher.stopWatch();
    ...
    protected void onDestroy() {
        ...
        if (mBroadcastReceiv != null)
            LocalBroadcastManager.getInstance(getApplicationContext()).unregisterReceiver(mBroadcastReceiv);
