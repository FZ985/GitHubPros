package com.kmtlibs.okhttp.base;
...
import com.kmtlibs.okhttp.callback.ProgressRequestListener;
import com.kmtlibs.okhttp.file.upload.ProgressRequestBody;
import com.kmtlibs.okhttp.tool.OkHttpLoggerInterceptor;
...
//                .sslSocketFactory(createSSLSocketFactory(), new OkTrustAllCerts()) // 信任所有证书~
        ...
        Log.e("OkHttpConf", " OkHttpConf newBuild..");
