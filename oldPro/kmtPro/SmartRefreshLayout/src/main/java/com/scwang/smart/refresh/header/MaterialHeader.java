...
import com.scwang.smart.refresh.R;
...
//        mProgress.setAlpha(255);
        ...
        mShowBezierWave = ta.getBoolean(R.styleable.MaterialHeader_srlHeaderShowBezierWave, mShowBezierWave);
        mScrollableWhenRefreshing = ta.getBoolean(R.styleable.MaterialHeader_srlHeaderScrollableWhenRefreshing, mScrollableWhenRefreshing);
        mBezierPaint.setColor(ta.getColor(R.styleable.MaterialHeader_srlPrimaryColor, 0xff11bbff));
        if (ta.hasValue(R.styleable.MaterialHeader_srlHeaderShadowRadius)) {
            int radius = ta.getDimensionPixelOffset(R.styleable.MaterialHeader_srlHeaderShadowRadius, 0);
