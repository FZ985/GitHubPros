...
import api29.libs.okhttp.file.download.DownLoadInfo;
import api29.libs.okhttp.file.download.DownLoadListenerAdapter;
import api29.libs.okhttp.file.download.DownloadResponseBody;
...
public class DownLoadBuilder {
    ...
    public void download(final DownLoadInfo info, @Nullable final DownLoadListenerAdapter listener) {
        if (isRunning) return;
