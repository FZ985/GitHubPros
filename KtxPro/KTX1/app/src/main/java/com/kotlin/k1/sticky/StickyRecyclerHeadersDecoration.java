...
import com.kotlin.k1.sticky.caching.HeaderProvider;
import com.kotlin.k1.sticky.caching.HeaderViewCache;
import com.kotlin.k1.sticky.calculation.DimensionCalculator;
import com.kotlin.k1.sticky.calculation.HeaderPositionCalculator;
import com.kotlin.k1.sticky.callback.ItemVisibilityAdapter;
import com.kotlin.k1.sticky.callback.StickyRecyclerHeadersAdapter;
import com.kotlin.k1.sticky.rendering.HeaderRenderer;
import com.kotlin.k1.sticky.util.LinearLayoutOrientationProvider;
import com.kotlin.k1.sticky.util.OrientationProvider;
...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        boolean bool = mHeaderPositionCalculator.hasNewHeader(itemPosition, mOrientationProvider.isReverseLayout(parent));
        System.out.println("==offsets:" + bool + ",itemPosition:" + itemPosition);
        if (bool) {
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            System.out.println("for1111:" + i);
            View itemView = parent.getChildAt(i);
            int position = parent.getChildAdapterPosition(itemView);
            System.out.println("for2222:" + position);
            ...
            System.out.println("for3333:" + position + "," + hasStickyHeader + ",hasNewHead:" + mHeaderPositionCalculator.hasNewHeader(position, mOrientationProvider.isReverseLayout(parent)));
